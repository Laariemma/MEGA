...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
    ...
    @auth
    <a href="{{ url('/employee/dashboard') }}" class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white">
    Työntekijä
    </a>
    @else
    ...
    <label for="category_name" class="block mb-2 text-black">Valitse kategoria:</label>
    ...
    <h2 class="text-2xl font-bold text-black mt-10 mb-4">Strategiaan tallennetut tiketit</h2>
    @if ($strategies->count())
